/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-env.d.ts` (hash: fbbcf2dca8ec1c6ee089327a8fcf9745)
...
interface __BaseEnv_Env {
	...
	BOT_USERNAME: "codra-esau";
	GITHUB_APP_SLUG: "codra-esau";
